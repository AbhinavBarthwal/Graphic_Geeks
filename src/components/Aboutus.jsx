const Aboutus = () => {
  return (
    <div className="w-full h-auto p-5 sm:p-10 lg:p-20 bg-[#023047]">
      <h1 className="text-white font-pixel text-3xl sm:text-4xl md:text-5xl p-4 sm:p-10">
        About us
      </h1>
      <div className="p-4 sm:p-10 text-slate-200 font-nerd text-base sm:text-lg">
        <h1 className="text-slate-200">
          Welcome to{" "}
          <span className="text-xl sm:text-2xl italic font-nerd text-yellow-400">
            &quot;Graphic Geeks&quot;
          </span>
